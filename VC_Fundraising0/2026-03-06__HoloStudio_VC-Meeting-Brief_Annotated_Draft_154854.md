...
|---------|------|--------|---------|
| 1.0 | 2026-03-06 | Eunjoo | Initial draft — VC positioning brief |
| 1.1 | 2026-03-06 | Eunjoo | ClawGene 섹션 실제 자료 기반으로 전면 업데이트 (Whitepaper v0.6.0, GTM v2.1) |
| 1.2 | 2026-03-06 | Eunjoo | VC 투자 관점 섹션 — 문서 목적(준비용) 명시 |
| 1.3 | 2026-03-06 | Eunjoo | HOOT 섹션 — Whitepaper v19/Architecture v4.0 기반으로 전면 교체. workflow automation → verified AI training data + on-chain model marketplace |
| 1.2 | 2026-03-06 | Eunjoo | ClawGene 레이어명 Bio-Compute → Physical AI Layer 변경 |
...
Trust / Data Infrastructure   ←── HOOT (AI training data), PlayArts (image consistency)
        ↓
Physical AI Layer             ←── ClawGene (BioFi — Proof of Useful Evolution)
        ↓
...
| 블록체인 | Arbitrum One (가스 $0.001–0.01/tx) |
...
단순 NFT 게임이 아니다. **지구상에서 완전한 커넥톰이 존재하는 유일한 생물(C. elegans)**의 279개 신경회로를 브라우저에서 시뮬레이션하고, 진화 결과를 온체인에 기록하는 프로토콜.
...
> "DeFi가 금융 계약을 프로그래밍 가능하게 만들었다면, BioFi는 생물 진화를 프로그래밍 가능하게 만들고 그 출력물에 경제적 가치를 부여한다. ClawGene은 이 카테고리를 정의하는 첫 번째 프로젝트다."
...
**VC 덱 배치 권장:**  
일반 AI/Web3 VC → 비중 축소 또는 후순위 (BioFi 카테고리 이해도 낮음)  
...
| HOOT 자동화 성공률 | Task 완료율 | 확인 필요 |

---

## 미팅 전 Action Items

- [ ] 각 프로젝트 benchmark 수치 최소 1개 이상 확보
- [ ] HOOT 기능 구현 완료 여부 CTO 확인
- [ ] PlayArts image consistency metric 수치화 방법 논의
- [ ] MoltVC 블록체인 필요성 설명 로직 정리
- [ ] ClawGene: 미팅 대상 VC가 DeSci/GameFi 특화인지 일반 AI/Web3인지 확인 후 덱 비중 결정
- [ ] ClawGene: Virtuals Unicorn Launch 일정 확정 여부 확인 (Commit 60일 기준점)
